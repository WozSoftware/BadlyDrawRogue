...
//            var itemEntity1 = Entity.Create(0, EntityType.OperationItem, "Item1");

//            var factory = EntityFactory.Create(new[] {tileEntity1, itemEntity1, tileEntity2});

//            CollectionAssert.AreEquivalent(
//                new[]{EntityType.Tile, EntityType.OperationItem},
...
//            CollectionAssert.AreEquivalent(
//                new[] { itemEntity1},
//                factory.Templates[EntityType.OperationItem].ToArray());
//        }
